...
import com.yr.shiro.session.CustomSessionManager;
import com.yr.shiro.util.AccountRealm;
import com.yr.shiro.util.ShiroToken;
import com.yr.shiro.util.SpringContextUtil;
import com.yr.shiro.util.UUser;
...
public class TokenManager {
	//用户登录管理
	public static final AccountRealm realm = SpringContextUtil.getBean("accountRealm",AccountRealm.class);
	//用户session管理

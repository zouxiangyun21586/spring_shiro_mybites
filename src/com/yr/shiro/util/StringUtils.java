...
public class StringUtils extends org.apache.commons.lang.StringUtils {
	...
	public static String getBASE64(String str, boolean... bf) {
		...
		String base64 = encoder.encodeToString(str.getBytes()); // jdk 1.8之后
		// String base64 = new sun.misc.BASE64Encoder().encode(str.getBytes()); // jdk 1.7
		// 去掉 '='
		if (isBlank(bf) && bf[0]) {
	...
	public static String getStrByBASE64(String s) {
		if (isBlank(s))
			return "";
		Decoder decoder = Base64.getDecoder(); // jdk 1.8之后
		// BASE64Decoder decoder = new BASE64Decoder(); // jdk 1.7
		try {
			byte[] b = decoder.decode(s); // jdk 1.8
			// byte[] b = decoder.decodeBuffer(s); // jdk 1.7
			return new String(b);
		} catch (Exception e) {
			return "";
		}
